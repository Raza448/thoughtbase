                       ...
                       <div class="box">
                                ...
                                <form action="" method="post" role="form">
									...
									?>
                                       <!-- <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" name="contact_name" id="name" value="<?php echo $user['contact_name'] ?>" placeholder="Contact Name" >
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Contact Number</label>
                                            <input type="text"  class="form-control" name="contact_number" id="number" value="<?php echo $user['contact_number'] ?>" placeholder="Contact Number" >
                                        </div>-->
										<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" name="zipcode" id="zipcode" value="<?php echo $user['zipcode'] ?>" placeholder="Zipcode" required>
                                        </div>
										<div class="form-group">
						  ...
						  ?> 
							...
							<div class="form-group">
									...
									<input name="company_name" type="text"  id="company" value="<?php echo $vendor['company_name'] ?>" class="form-control " />
							...
							<div class="form-group">
									...
									<textarea  name="description" id="company_desc" class="form-control "><?php echo $vendor['description'] ?></textarea>
									<div id="results-company_desc" class="results error"></div>
									<div id="errorcontainer-company_desc" class='errorDiv'></div>
							</div>
							<div class="form-group">
									<label>First Name <span class="mandatory">*</span></label>
									<input name="fname" type="text"  id="fname" value="<?php echo $vendor['fname'] ?>" class="form-control " />
									<div id="results-fname" class="results error"></div>
									<div id="errorcontainer-fname" class='errorDiv'></div>
							</div>
							<div class="form-group">
									<label>Last Name <span class="mandatory">*</span></label>
									<input name="lname" type="text"  id="lname" value="<?php echo $vendor['lname'] ?>" class="form-control " />
							...
							<div class="form-group">
									...
									<textarea  name="uen" id="addr1" class="form-control "><?php echo $vendor['uen'] ?></textarea>
									<div id="results-addr1" class="results error"></div>
									<div id="errorcontainer-addr1" class='errorDiv'></div>
							</div>
							<div class="form-group">
									<label>Address Line 2</label>
									<textarea  class="form-control " id="addr2" name="addr"><?php echo $vendor['addr'] ?></textarea>
									<div id="results-addr2" class="results error"></div>
									<div id="errorcontainer-addr2" class='errorDiv'></div>
							</div>
							<div class="form-group">
									<label>City <span class="mandatory">*</span></label>
									<input name="city" type="text"  id="city" value="<?php echo $vendor['city'] ?>" class="form-control " />
									<div id="results-city" class="results error"></div>
									<div id="errorcontainer-city" class='errorDiv'></div>
							</div>
							<div class="form-group">
									<label>State <span class="mandatory">*</span></label>
									<input name="state" type="text"  id="state" value="<?php echo $vendor['state'] ?>" class="form-control " />
							...
							<div class="form-group">
									...
									<input name="contact_number" type="text"  id="contact_number" data-inputmask="'mask': ['(999)-999-9999']" value="<?php echo $vendor['contact_number'] ?>" class="form-control " required />
