                       ...
                       <div class="box">
                                ...
                                <form action="" method="post" role="form" id="<?php echo ((isset($_GET['id']))?'modify_template-form':'add_template-form') ?>" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
										...
										<input type="text"  class="form-control" name="temp_name" id="name" value="<?php echo $template['name'] ?>" >
									...
									<div class="col-xs-10">
										...
										if(isset($answers))
										{
											...
											<input type="text"  class="form-control" name="answer[]" id="name" value="<?php echo $row['answer'] ?>" required></div>
									...
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="title" id="name"  placeholder="Category Name" >
										<div id="errorcontainer-name" class='errorDiv'></div>
                                    </div>
                                    <div class="box-footer">
