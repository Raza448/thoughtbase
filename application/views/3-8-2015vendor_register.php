						 ...
						 <li>
						   <div class="col-md-12">
									<div class="col-md-6" style="float:none;margin:0 auto;">
										<form action="<?php echo site_url('main/businessRegister'); ?>" id="register-form" novalidate="novalidate" method="POST" type="post">
										<?php $this->load->view('components/vendor_register_form'); ?>	
										<div class="row">
											<div class="col-md-12">
												<input type="submit" value="Create Account" id="register" class="btn btn-default pull-left" data-loading-text="Loading...">
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
