			   ...
			   <?php 
				...
				//5 = textarea
				   ...
				   <?php }else if($valz['question'] == 4){ //checkbox ?>
				    ...
				    <?php } ?>
				   <?php }else{  ?>
					  <textarea  id="general<?php echo $bp ?>" class="form-control input-sl  s<?php echo $bp; ?>" name="general_thought" ></textarea>
			   ...
			   <?php 
				...
				//5 = textarea
				   ...
				   <?php }else if($valz['question'] == 4){ //checkbox ?>
				    ...
				    <?php } ?>
				   <?php }else{  ?>
					 <textarea  class="form-control input-sl  s<?php echo $bp; ?>" name="general_thought" ></textarea>
				   <?php } ?>
				 </ul>
			   </li> 
			</ul>
	   ...
	   $result2 = $this->db->query('select * from survey_questions where survey_id ='.$single[0]['template'].' and ans_type=2 order by question_cat')->result_array();
		...
		<ul style="list-style-type:none;padding:0px;display:none;"  class="a<?php echo $valz1['question_cat']; ?>" >
			   ...
			   <?php
			    ...
			    <li>
			      <ul style="list-style-type:none;padding:10px;">
				  <textarea  id="general<?php echo $r ?>" class="form-control input-sl  s<?php echo $bp; ?>" name="general_thought" ></textarea><div id="results-general<?php echo $r ?>" class="results error"></div>
		...
		$r++;
			 ...
			 <div class="col-md-12 a1" style="display:none;">
				<label>Enter text from the below image <span class="mandatory">*</span></label>
				<input name="captcha1" id="captcha1" type="text"  value=""  class="form-control input-lg"  required><div id="errorcontainer-captcha1" class='errorDiv'></div>
