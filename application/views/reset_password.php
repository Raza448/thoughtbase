													...
													<div class="row">
														...
														<div class="form-group">
															...
															<div class="col-md-12">
																...
																<input name="pass" type="password"  autocorrect="off" autocapitalize="none" value="<?php echo set_value('password'); ?>" class="form-control input-lg" id="pass">
														...
														<div class="form-group">
															...
															<div class="col-md-12">
																...
																<input name="confirm_pass" type="password"  autocorrect="off" autocapitalize="none" value="<?php echo set_value('confirm_pass'); ?>" class="form-control input-lg" id="confirm_pass">
