			...
			<div class="row">
				<div class="form-group">
					<div class="col-md-12">
						...
						<input type="text"  name="uen" id="addr1" class="form-control input-lg" value="<?php echo set_value('uen',(isset($uen) ? stripslashes($uen):'')); ?>">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-md-12">
						...
						<input type="text"  class="form-control input-lg" id="addr2" name="addr" value="<?php echo set_value('addr',(isset($addr) ? stripslashes($addr):'')); ?>">
