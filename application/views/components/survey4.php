...
<div class="row">
	<div class="form-group">
		<!--<div class="col-md-12">
			...
			<label style="font-size: 20px;">Amount $<?php echo $rout[0]['amount']; ?></label>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input type="text"  name="customer_first_name" id="fname" value="<?php echo stripslashes($vout['fname'])  ?>"   required  class="form-control input-lg" />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input type="text"  name="customer_last_name" id="lname" value="<?php echo stripslashes($vout['lname'])  ?>"   required   class="form-control input-lg"  />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input type="text"  name="customer_address1" id="addr1" value="<?php echo set_value('customer_address1',(isset($vout['uen']) ? stripslashes($vout['uen']):'')); ?>"   required   class="form-control input-lg" />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input type="text"  name="customer_address2" id="addr2" value="<?php echo set_value('customer_address2',(isset($vout['addr']) ? stripslashes($vout['addr']):'')); ?>"    required  class="form-control input-lg" />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input type="text"  name="customer_city" id="city" value="<?php echo stripslashes($vout['city'])  ?>"    required  class="form-control input-lg" />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input type="text"  name="customer_state" id="state" value="<?php echo stripslashes($vout['state'])  ?>"   required  class="form-control input-lg" />
...
<div class="col-md-12">
	...
	<div class="form-group">
		<div class="col-md-6 payment_details">
			...
			<input type="number" name="card_num" id="card_number" class="form-control input-lg" value="4992645597903115" autocomplete="cc-number" />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-4 payment_details">
			...
			<select name="card-exp-month" class="form-control input-lg" id="month" autocomplete="cc-exp-month" />
...
<label>Year<span class="mandatory">*</span></label>
  <?php $vv2 = isset($_POST['cc_expiration_year']) ? $_POST['cc_expiration_year']: ''; ?>
		  ...
		  <select name="card-exp-year"  class="form-control input-lg" id="year" autocomplete="cc-exp-year" />
		...
		<div class="col-md-4 payment_details">
			...
			<input type="number" name="card_csc" id="card_verification" class="form-control input-lg" value="456" autocomplete="cc-csc" />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
            ...
            ?>
			<?php if(isset($tot)) {echo $tot; } ?>
			<label style="font-size: 20px;font-weight: bold;">Total:  $<?php echo $rout[0]['amount']; ?></label>
			<input type="hidden" name="example_payment_amuont" value="<?php echo $rout[0]['amount']; ?>" >
			</div>
		</div>
	</div>
...
<div class="row">
 ...
 <?php if($this->session->userdata('step1')){ ?>
   <a class="btn btn-default pull-left" href="<?php echo site_url('business/step2'); ?>"><< Back</a>
 <?php } ?>
  </div>
  
  <div class="col-md-6" >
  <?php if($rout[0]['amount'] > 0 ){ ?>
   <input type="submit" value="Make Payment" id="payment" class="btn btn-default pull-right" data-loading-text="Loading...">
  <?php }else{ ?>
  <div class="null_payment">Payment Amount should be above $0</div>
  <?php } ?>
   </div>  
  </div>
<!--<div class="row">
  <div class="col-md-6">
   <?php if($this->session->userdata('step2')){ ?>
    ...
    <a class="btn btn-default pull-left" onclick="window.history.back(-1)"><< Back</a>
 <?php } ?>
 </div>
 <div class="col-md-6">
  <?php if($rout[0]['amount'] > 0 ){ ?>
  ...
  <div class="col-md-12" style="margin-top:20px;text-align:center;"><strong>Payment Amount should be above $0</strong></div>
</div>-->
...
/* $(function() {
    var card_details = [
      localStorage.getItem("card_details")
    ];
    $( "#card_number" ).autocomplete({
      source: card_details
    });
  });
// Check browser support
$('#payment').click(function(){
		var card_details = $('#card_number').val();
		//alert(card_details);
		var year = $('#year').val();
		var month = $('#month').val();
		var cvv = $('#card_verification').val();
		//alert(year+'\n'+month+'\n'+cvv);
		if (typeof(Storage) != "undefined") {
		//Store
			localStorage.setItem("card_details", card_details);
			localStorage.setItem("year", year);
			localStorage.setItem("month", month);
			localStorage.setItem("cvv", cvv);
		//Retrieve
		//document.getElementById("card").value = localStorage.getItem("card_details");
		} else {
			//document.getElementById("result").value = "Sorry, your browser does not support Web Storage...";
		}
}); */
/* document.getElementById("card_number").value = localStorage.getItem("card_details");
document.getElementById("card_verification").value = localStorage.getItem("cvv");
