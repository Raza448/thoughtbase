...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input name="userName" type="text" id="company" value="<?php echo set_value('userName',(isset($name) ? $name:'')); ?>" class="form-control input-lg" required pattern="[a-zA-Z ]+" />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea name="company" id="company_desc" class="form-control input-lg" required><?php echo set_value('company',(isset($company_name) ? $company_name:'')); ?></textarea>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea name="uen" id="addr1" class="form-control input-lg"><?php echo set_value('uen',(isset($uen) ? $uen:'')); ?></textarea>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input name="vendor_email" type="email" autocorrect="off" autocapitalize="none" id="email" value="<?php echo set_value('email',(isset($email) ? $email:'')); ?>" class="form-control input-lg" required />
...
<form action="<?php echo site_url('business/profile'); ?>" id="change-pass-form" novalidate="novalidate" method="POST" type="post">
