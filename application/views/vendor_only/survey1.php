...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea  name="description" id="desc" class="form-control input-lg" required><?php echo isset($data_temp[0]['description']) ? stripslashes($data_temp[0]['description']) : set_value('description'); ?></textarea>
			<div class="col-md-6">
