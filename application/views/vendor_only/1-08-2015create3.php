				...
				<ul class="portfolio-list" data-sort-id="portfolio" style="position: relative;height:auto;min-height:850px;">
					<li class="" >
						...
						<ul class="portfolio-list">
						 <li class="col-md-6 ">
						   <h4><b>Select Target Audience</b></h4>
...
<div class="row">
  <div class="col-md-12" style="padding-top:20px;" >
   <input type="submit" value="Next >>" style="float:right;" id="bback" class="btn btn-primary" data-loading-text="Loading...">
 <?php if($this->session->userdata('step1')){ ?>
   <a style="float:left;" class="btn btn-primary" href="<?php echo site_url('business/step1'); ?>"><< Back</a>
 <?php } ?>
  </div>
</div>
<div class="row">
