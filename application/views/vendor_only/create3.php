...
<form method="post" id="query-form" novalidate="novalidate" enctype="multipart/form-data">
					<div class="row">
						 <div class="col-md-12 custom_option" >
						 <h3><b>Select Target Audience</b></h3><br />
						 <?php $aud = 1; ?>
							 <?php if($this->session->userdata('aud')){
								 $aud = $this->session->userdata('aud');
							 } ?>
								<div class="col-md-6 pad-0">
								<label>
								 <input type="radio" name="custom_users" id="target_aud" class="target_aud" value="1" <?php echo (($aud !=2)?'checked': '') ?>>
								 <!--<label style="font-size: 18px;"><span><span></span></span>Select Target Audience</label>&nbsp;&nbsp;-->
								 <div style="font-size: 18px;"><span><span></span></span>Target ThoughtBase Users</div>
								 </label>&nbsp;&nbsp;
								</div>
								<div class="col-md-6 pad-0">
								 <label><input type="radio" name="custom_users" id="custom_email" class="custom_email" value="2" <?php echo (($aud ==2)?'checked': '') ?>>
								 <!--<label style="font-size: 18px;"><span><span></span></span>Select Target Audience</label>&nbsp;&nbsp;-->
								 <div style="font-size: 18px;"><span><span></span></span>Enter Customer Emails</div></label>&nbsp;&nbsp;
								</div>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea  name="description" id="desc" class="form-control input-lg" style="min-height: 150px;"><?php print_r($this->session->userdata('emails')); ?></textarea>
...
<ul class="portfolio-list" data-sort-id="portfolio" style="position: relative;height:auto;">
						...
						<ul class="portfolio-list">
						 ...
						 <li class="check_radio" style="overflow: hidden;width: 100%;">
						  <?php 
						  ...
						  ?>
							...
							<div style="/*margin-left:-5%*/"><span><span></span></span><?php echo $y['name']; ?></div></label><br />
...
<div class="row">
  ...
  <div class="alert alert-info">
     <h3 style="text-transform: lowercase;margin-bottom: 0 !important;"><span><span id="use" style="line-height: 1.5;"><?php echo $tot; ?></span> user(s) selected </span><br><span style="color: #9cc879;line-height: 2.5;"> $
	 <?php 
...
<div class="row">
 ...
 <?php if($this->session->userdata('step1')){ ?>
   <a class="btn btn-default pull-left" href="<?php echo site_url('business/step1'); ?>"><< Back</a>
 <?php } ?>
  </div>
  <div class="col-md-6" >
   <input type="button" value="Next >>" id="bback" class="btn btn-default pull-right" data-loading-text="Loading...">
   </div>  
  </div>
</div>
</div>
...
<script type="text/javascript" >
 ...
 function manu(a){
	...
	$("#desc").change(function(ch) {
		$('#bback').attr('disabled','disabled');
		var a = $(this).val();
		var id = $(this).attr('id');
		//ajax_spam(a,id);
		call_cutom_ajax(function(){});
	});
	...
	function call_cutom_ajax(callback) {
		if(timer) {
			clearTimeout(timer);
		}
		var b = $('#desc').val();
