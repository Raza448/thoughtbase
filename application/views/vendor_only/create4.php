			...
			<div class="col-md-12">
				...
				<ul class="portfolio-list" data-sort-id="portfolio" style="position: relative;height:auto;min-height:850px;">
						...
						<ul class="portfolio-list">
						 ...
						 <li class="col-md-9 " style="float:none;margin: 0 auto">
        ...
        setupFormValidation: function()
        {
            ...
            $("#payment-form").validate({
                ...
                messages: {
					...
					card_num : "Please Enter 16 Characters of your Card Number",
					card_csc : "Please Enter 3 Characters of your CVV Number"
                },
