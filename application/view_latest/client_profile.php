...
<ul class="portfolio-list col-md-6" data-sort-id="portfolio" style="position: relative;height:auto;">
  ...
  <div class="form-group">
	...
	<div class="col-md-12">
		...
		if(!empty($out))
		{ ?>
		<input type="text" autocorrect="off" autocapitalize="none" class="form-control input-lg" name="username" id="username" value="<?php echo set_value('zipcode',(isset($out['username']) ? $out['username']:'')); ?>" /><div id="results-username" class="results error"></div><div id="errorcontainer-username" class='errorDiv'></div><br />
		...
		<div class="row">
			<div class="form-group">
				<div class="col-md-6">
					...
					<input name="new_password" type="password" id="new_password" value="<?php echo set_value('password'); ?>" class="form-control input-lg" >
					<div id="errorcontainer-new_password" class='errorDiv'></div>
				</div>
				<div class="col-md-6">
					<label>Re-enter Password <span class="mandatory">*</span></label>
					<input name="re_pass" type="password" id="re_pass" value="<?php echo set_value('confirm_password'); ?>"  class="form-control input-lg" />
		...
		{
		?>
		<input type="text" autocorrect="off" autocapitalize="none" class="form-control input-lg" name="username" id="username" value="<?php echo $result['username']; ?>" disabled /><div id="results-username" class="results error"></div><div id="errorcontainer-username" class='errorDiv'></div><br />
		<?php
		}
		?>
