...
<tr>
<td style="padding-top:20px;">Thank you for contacting ThoughtBase.  Your are requesting to reset your password:<br />
<a href="<?php echo site_url('main/reset_password/'.$token); ?>">Click here to Reset your Password</a>
</td>
</tr>
<tr>
