													...
													<div class="row">
														<div class="form-group">
															<div class="col-md-12">
																...
																<input name="username" type="text" autocorrect="off" autocapitalize="none" value="<?php echo $ter1; ?>" class="form-control input-lg" required>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="form-group">
															<div class="col-md-12">
																...
																<input name="password" type="password" value="<?php echo $pass1; ?>" class="form-control input-lg" required>
															</div>
														</div>
													</div>
													<div class="row">
