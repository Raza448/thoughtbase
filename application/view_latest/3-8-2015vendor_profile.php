			...
			<div class="col-md-12">
					<?php //$this->load->view('vendor_menu'); ?>	
						...
						<div class="row">
						 ...
						 <li class="col-md-6 deact">
						 <div style="margin-top:40px;">
						   <h4 style="float:left;">Deactivate Account</h4><a onClick="return confirm('Are you sure you want to delete this account ?');" href="<?php echo site_url('business/deactivate'); ?>"> <input type="button" value="Deactivate" class="btn btn-primary pull-right" data-loading-text="Loading..."></a>
						   </div>
