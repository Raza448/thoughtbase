                       ...
                       <div class="box">
                                ...
                                <form action="" method="post" role="form">
									...
									?>
										...
										<input type="text" autocorrect="off" autocapitalize="none" class="form-control" name="cat_name" id="name" value="<?php echo $category['name'] ?>"  placeholder="Category Name" required>
                                    </div>
