...
<?$this->layout->block()?>
	...
	<div class="col-md-12">
		<div class="row" style="margin-left: 0;">
			<h4 class="col-md-6" style="float: left;line-height: 2.2;margin-bottom: 0 !important;width:auto;">Deactivate Account</h4>

			<a class="col-md-6 pull-right deactivate" href="<?php echo site_url('business/deactivate'); ?>" style="margin-top:5px;" onclick="return confirm('Are you sure want to deactivate your account ?');"><button type="button" class="btn btn-deactivate col-md-12">Deactivate</button></a>
		</div>
	</div>
