                               ...
                               $out_vendor = ($this->session->userdata('vendorAuth') != FALSE) ? 1:0;
								...
								<span>
								 <div class="form-group">
									...
									?>									
									<input name="username" value="<?php echo $ter; ?>" class="form-control" id="top_username" placeholder="Username" autocorrect="off" autocapitalize="none">
									<div id="errorcontainer-top_username" class='errorDiv'></div>
								  </div>
								  <div class="form-group password_box">
									<label class="sr-only" for="exampleInputPassword3">Password</label>
									<input name="password" type="password" value="<?php echo $pass; ?>" id="top_password" class="form-control" placeholder="Password" />
