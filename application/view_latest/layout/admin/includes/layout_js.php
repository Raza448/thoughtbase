...
jQuery.validator.setDefaults({
    ...
    $(".add_field_button").click(function(e){ //on add input button click
        ...
        if(x < 10){ //max input box allowed
			...
			$('<div style="display: none;"><input type="text" autocorrect="off" autocapitalize="none" class="form-control" name="answer[]" /><a href="#" class="remove_field">remove</a></div>').appendTo($(".input_fields_wrap")).slideDown("slow");
        }
    });
