...
<?$this->layout->block()?>
	<div class="container">
		...
		<div class="col-md-12">
			<h3>Payments</h3><br/>			
			<h6><strong>Total payments to date:&nbsp;<span style="width:auto !important;">$<?php echo number_format($ouz[0]['amountz'],2);  ?></span></strong></h3>
		</div>
					...
					<tbody>	
								 ...
								 ?>	
									<tr>
											...
											<td>
												<?php echo "<b class='queries'>".$val['survey']."</b>"; ?>&nbsp;&nbsp;&nbsp;<?php echo '$ '.number_format($val['amount'],2); ?><br />
												<?php echo date('m/d/Y',strtotime($val['date'])); ?>
											</td>
									</tr>
								<?php $i++;}}else{ ?>		
