  ...
  <div class="col-md-12 " style="height:auto;padding-top:40px;" >
	 ...
	 <div id="errorcontainer-general<?php echo $bp ?>" class='errorDiv'></div>
		<div class="col-md-7 a3 captcha_text" style="padding: 10px 20px 10px 10px;">
			...
			<input name="captcha" id="captcha" type="text" autocorrect="off" autocapitalize="none" value=""  class="form-control input-lg"  required><div id="errorcontainer-captcha" class='errorDiv error_captcha'></div>
		...
		<div class="col-md-7 a3 captcha_text" style="display:none;">
			<label>Enter text from the below image <span class="mandatory">*</span></label>
			<input name="captcha1" id="captcha1" type="text" autocorrect="off" autocapitalize="none" value=""  class="form-control input-lg"  required><div id="errorcontainer-captcha1" class='errorDiv error_captcha'></div>
