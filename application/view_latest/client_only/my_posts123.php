      ...
      <?php if( $single[0]['template'] == 4 ){ ?>
        <label class="ques_1"><?php echo $single[0]['question']; ?></label><br />
	     <ul class="ques_1" style="list-style:none;padding:0px;padding-top:5px;">
	       <li><textarea autocorrect="off" autocapitalize="none" data-bvalidator-msg="required"  data-bvalidator="required" class="form-control input-lg" name="single_question" required ></textarea></li>
	     </ul>
			   ...
			   <?php 
				...
				//5 = textarea
				   ...
				   <?php }else if($valz['question'] == 4){ //checkbox ?>
				    ...
				    <?php } ?>
				   <?php }else{  ?>
					  <textarea autocorrect="off" autocapitalize="none" data-bvalidator="required" data-bvalidator-msg="required "  class="form-control input-sl  s<?php echo $bp; ?>" name="<?php echo $valz['id']; ?>" ></textarea>
				   <?php } ?>
				 </ul>
			   </li> 
			</ul>
