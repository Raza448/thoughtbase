...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			<label>Use the Description area to add promotional text. Think of this as textual ad space.</label>
			<textarea autocorrect="off" autocapitalize="none" name="description" id="desc" class="form-control input-lg" placeholder="Optional" required><?php echo isset($data_temp[0]['description']) ? stripslashes($data_temp[0]['description']) : set_value('description'); ?></textarea>
			<div class="col-md-6">
