			...
			<div class="row">
				<div class="form-group">
					<div class="col-md-12">
						...
						<input type="text" autocorrect="off" autocapitalize="none" class="form-control input-lg" id="addr1" name="uen" value="<?php echo set_value('uen',(isset($uen) ? $uen:'')); ?>">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-md-12">
						...
						<input type="text" autocorrect="off" autocapitalize="none" class="form-control input-lg" id="addr2" name="addr" value="<?php echo set_value('addr',(isset($addr) ? $addr:'')); ?>">
