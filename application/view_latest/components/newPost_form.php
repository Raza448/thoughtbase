...
<div class="row">
	...
	<div class="col-md-12">
			...
			<input maxlength="100" class="form-control input-lg" id="delivery_dt" name="delivery_dt" value="<?php echo isset($delivery_dt) ? $delivery_dt :''; ?>" data-date-format="DD/MM/YYYY HH:mm" data-date-minDate="<?php echo @date('d/m/Y'); ?>" type="text" autocorrect="off" autocapitalize="none"></input>
...
<div class="row">
	...
	<div class="col-md-12">
			...
			<textarea autocorrect="off" autocapitalize="none" maxlength="5000" rows="4" class="form-control" name="address" id="address"><?php echo isset($address) ? $address :'';?></textarea>
	</div>
	</div>
</div>
<div class="row">
...
<div class="row">
	...
	<div class="form-group">	
			<div class="col-md-5">
			<label for="budget">Budget per <a href="#" id="unit" data-type="text" autocorrect="off" autocapitalize="none" data-pk="1" data-url="" data-title="Example: pax, table, hour...ect"><?php echo isset($post_unit) ? $post_unit :'unit';?></a> (click to change.)</label>
			<input type="hidden" name="post_unit" id="post_unit" value="" />
			<input maxlength="100" class="form-control input-lg num" id="budget" value="<?php echo isset($budget) ? $budget :'';?>" onkeyup="show_total();"  name="budget" type="text" autocorrect="off" autocapitalize="none"></input>
			</div>
			<div class="col-md-3">
			<label for="quantity">Quantity</label>
			<input maxlength="100" class="form-control input-lg num" id="quantity" value="<?php echo isset($quantity) ? $quantity :'';?>"  onkeyup="show_total();"  name="quantity" type="text" autocorrect="off" autocapitalize="none"></input>
			</div>
			<div class="col-md-4">
			<label for="total">Total</label>
			<input maxlength="100" class="form-control input-lg" readonly id="total" value="<?php echo isset($total) ? $total :'';?>" name="total" type="text" autocorrect="off" autocapitalize="none"></input>
			</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-12">
			...
			<input maxlength="100" class="form-control input-lg" id="contact_number" value="<?php echo $contact_no; ?>" name="contact_number" type="text" autocorrect="off" autocapitalize="none"></input>
	</div>
	</div>
</div>
<?php } ?>
...
<div class="row">
	...
	<div class="col-md-12">
			...
			<textarea autocorrect="off" autocapitalize="none" maxlength="5000" rows="4" class="form-control" name="description" id="description"><?php echo isset($description) ? $description : ''; ?></textarea>
	</div>
	</div>
</div>
