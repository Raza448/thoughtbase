...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea autocorrect="off" autocapitalize="none" name="uen" id="addr1" class="form-control input-lg"><?php echo set_value('uen',(isset($uen) ? stripslashes($uen):'')); ?></textarea>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea autocorrect="off" autocapitalize="none" class="form-control input-lg" id="addr2" name="addr" required><?php echo set_value('addr',(isset($addr) ? stripslashes($addr):'')); ?></textarea>
