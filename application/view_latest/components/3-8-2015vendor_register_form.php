<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input name="userName" type="text" autocorrect="off" autocapitalize="none" id="company" value="<?php echo set_value('userName',(isset($userName) ? $userName:'')); ?>" class="form-control input-lg"  />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea autocorrect="off" autocapitalize="none" class="form-control input-lg" name="company" id="company_desc" ><?php echo set_value('company',(isset($company) ? $company:'')); ?></textarea>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea autocorrect="off" autocapitalize="none" class="form-control input-lg" id="addr1" name="uen" required><?php echo set_value('uen',(isset($uen) ? $uen:'')); ?></textarea>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<textarea autocorrect="off" autocapitalize="none" class="form-control input-lg" id="addr2" name="addr" required><?php echo set_value('addr',(isset($addr) ? $addr:'')); ?></textarea>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input name="state" type="text" autocorrect="off" autocapitalize="none" id="state" value="<?php echo set_value('state',(isset($state) ? $state:'')); ?>" class="form-control input-lg" required pattern="[a-zA-Z ]+" />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input name="contact_number" id="contact_number" type="text" autocorrect="off" autocapitalize="none" data-inputmask="'mask': ['(999)-999-9999']" value="<?php echo set_value('contact_number',(isset($contact_number) ? $contact_number:'')); ?>" class="form-control input-lg" required />
...
<div class="row">
	<div class="form-group">
		<div class="col-md-6">
			...
			<input name="password" type="password" id="password" value="<?php echo set_value('password'); ?>" class="form-control input-lg"  required>
			<div id="errorcontainer-password" class='errorDiv'></div>
		</div>
		<div class="col-md-6">
			<label>Re-enter Password <span class="mandatory">*</span></label>
			<input name="confirm_password" type="password" id="confirm_pass" value="<?php echo set_value('confirm_password'); ?>"  class="form-control input-lg"  required>
...
<div class="row">
	<div class="form-group">
		<div class="col-md-12">
			...
			<input name="captcha" type="text" autocorrect="off" autocapitalize="none" id="captcha" value=""  class="form-control input-lg" style="  margin-bottom: 10px;"><div id="errorcontainer-captcha" class='errorDiv'></div>
	...
	<div class="checkbox">
	<label for="terms">
		<input type="checkbox" name="term" id="terms" value="1" <?php echo ((set_value('term') == 1) ? 'checked' : ''); ?> />I agree to the ThoughtBase <a href="terms_condition" style="color:blue;">Terms of Service.</a><span class="mandatory">*</span>
